  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <img src={SwishLogo} alt="" crossOrigin="anonymous" style={{ height: 18, width: "auto", display: "block", verticalAlign: "middle" }} />
        <span style={{ fontSize: 11, color: watermark, fontWeight: 600, lineHeight: 1, verticalAlign: "middle" }}>
